...
void RopeLifeDownEfect::Draw()
{
	...
	MyDrawTurn::Instance().SetDrawBrightItem(_posX - _width / 4, _posY - _height / 4, _gh_efect, 0.82f, 255, 255, 255, 
		BLENDMODE_ADD, _paramVol, DRAWTYPE_DRAWEXTENDGRAPH,0,_posX + _width / 4,_posY + _height / 4);
	MyDrawTurn::Instance().SetDrawBrightItem(_posX - _width / 3, _posY - _height / 3, _gh_efect, 0.82f, 0, 255, 0,
