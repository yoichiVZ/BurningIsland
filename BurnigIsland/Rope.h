...
private:
	...
	int _fireFlag[IslandInfo::Island_Num][IslandInfo::Island_Num];
	int _fireStartCount[IslandInfo::Island_Num][IslandInfo::Island_Num];
	int _fireStartFlag[IslandInfo::Island_Num][IslandInfo::Island_Num];
	int _maxRopeLife;
	int _ropeLife;
...
public:
	...
	// 燃えているか
	int GetFireFlag(int island1, int island2);
	// 燃え始めているか
