...
{
	if (island1 < 0 || island1 >= IslandInfo::Island_Num || island2 < 0 || island2 >= IslandInfo::Island_Num)return false;
	if (_fireFlag[island1][island2] == 1) { // ©•ª‚Ì“‡‚©‚ç”R‚¦‚Ä‚¢‚é
		return 1;
	}
	if (_fireFlag[island2][island1] == 1) { // ‘Šè‚Ì“‡‚©‚ç”R‚¦‚Ä‚¢‚é
		return 2;
	}
...
{
	if (island1 < 0 || island1 >= IslandInfo::Island_Num || island2 < 0 || island2 >= IslandInfo::Island_Num)return false;
	if (_fireStartFlag[island1][island2] == 1) { // ©•ª‚Ì“‡‚©‚ç”R‚¦n‚ß‚Ä‚¢‚é
		return 1;
	}
	if (_fireStartFlag[island2][island1] == 1) { // ‘Šè‚Ì“‡‚©‚ç”R‚¦n‚ß‚Ä‚¢‚é
		return 2;
	}
